          ...
          >
            <div className="px-5 py-6 bg-zinc-50/50 rounded-[28px] mb-3 border border-gray-50">
                <div className="flex items-center gap-4 mb-4">
                    <div className="w-14 h-14 rounded-2xl overflow-hidden border-4 border-white shadow-lg bg-white flex items-center justify-center text-primary">
                        {user.image ? (
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="text-sm font-black text-foreground truncate tracking-tighter">{user.name}</p>
            ...
            <div className="h-px bg-gray-50 my-4 mx-6" />
            ...
            <div className="px-2">
                ...
                className="w-full flex items-center gap-4 px-5 py-5 rounded-[22px] text-red-500 hover:bg-red-50 transition-all font-black text-[11px] uppercase tracking-[0.2em] cursor-pointer"
                >
                <LogOut size={20} />
                Log Out
                </button>
