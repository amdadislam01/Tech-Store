  ...
  return (
    <section className="mb-32">
        <div className="flex items-end justify-between mb-16">
            <div>
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-primary mb-4 block">Tech Insights</span>
                <h2 className="text-4xl font-black text-gray-900 tracking-tighter">Stay <span className="text-primary">Ahead</span> of the curve.</h2>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
                ...
                { title: "Top 10 Flagship Devices for 2024", category: "Culture", img: "https://i.ytimg.com/vi/TD0Are31diM/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLDaAgWtxQ9JlEhpmYM_CG_4p1k_3w" },
                { title: "Inside the Munich Logic Hub", category: "Studio", img: "https://images.unsplash.com/photo-1497215728101-856f4ea42174?q=80&w=2670&auto=format&fit=crop" }
            ].map((post, i) => (
                <motion.div
                    key={i}
                    whileHover={{ y: -10 }}
