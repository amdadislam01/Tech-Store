...
const IMPACT_STATS = [
  ...
  { label: "Expert Support", value: "24/7/365", icon: Zap, color: "text-primary" },
  { label: "Shipping Worldwide", value: "180+", icon: Globe, color: "text-blue-500" },
];
      ...
      <div className="container-custom">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
             ...
             <span className="text-[10px] font-black uppercase tracking-[0.25em]">Loved by Thousands</span>
          </motion.div>
          ...
          >
            Powering Workspaces <br /> 
            <span className="text-transparent bg-clip-text bg-gradient-to-br from-gray-900 via-gray-600 to-primary/80">Everywhere.</span>
          </motion.h2>
          ...
          >
            From home offices to professional studios, we&apos;re proud to power the dreams of tech enthusiasts around the world.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 items-center border-t border-gray-100 pt-32">
             <div className="flex flex-col gap-2">
                 ...
                 <p className="text-xs font-bold text-gray-900">Trusted by Professional Innovators</p>
             </div>
